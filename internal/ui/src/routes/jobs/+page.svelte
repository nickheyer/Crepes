<script>
    ...
    import { jobs, loadJobs, startJobById, stopJobById, removeJob, createJobModal } from '$lib/stores/jobStore';
      ...
      <div class="flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div class="w-full md:w-auto">
          ...
          <select
            ...
            class="w-full md:w-auto rounded-md bg-base-700 border border-dark-600 py-2 px-3 pr-8 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
          >
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen">
        ...
        <div class="relative bg-base-800 rounded-lg overflow-hidden shadow-xl transform transition-all w-full max-w-5xl">
          <JobWizard 
            on:success={() => createJobModal.set(false)}
            on:cancel={() => createJobModal.set(false)}
          />
        </div>
      </div>
    </div>
