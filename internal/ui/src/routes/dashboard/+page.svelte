...
{#if $createJobModal}
    <dialog class="modal modal-open">
        ...
        <form method="dialog" class="modal-backdrop">
            <button onclick={() => createJobModal.set(false)}>close</button>
        </form>
    </dialog>
{/if}
